...
namespace mars {
  namespace sim {
    ...
    void BaseMotor::setDesiredMotorAngle(sReal angle) {
    ...
    void BaseMotor::setMaxEffort(sReal force) {
    ...
    sReal BaseMotor::getMotorMaxForce() const {
      return maxEffort;
    }

    sReal BaseMotor::getActualAngle() const {
      return actualAngle1;
    }
